...
HTML deck 瀏覽器演講 · `html2pptx.js` 讀 DOM 的 computedStyle 逐元素翻譯成 PowerPoint 物件 · 匯出的是**真文本框**，PPT 裡雙擊即可編輯。
...
**商用授權聯絡方式**：郵件 **alchaincyf@gmail.com**（優先），或私信下方任一社交平臺。
