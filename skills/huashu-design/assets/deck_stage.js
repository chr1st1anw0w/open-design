/**
 * <deck-stage> — HTML幻燈片外殼web component
 *
 * 提供功能：
 * - 固定尺寸canvas（預設1920×1080）+ auto-scale + letterbox
 * - 鍵盤導航（←/→/Space/Home/End/Esc）
 * - 左右點選區域導航
 * - slide counter (當前/總數)
 * - localStorage持久化當前slide
 * - Speaker notes postMessage (支援外層渲染)
 * - Hash導航 (#slide-5 跳到第5張)
 * - Print-to-PDF支援 (Cmd+P / Ctrl+P 一頁一slide)
 * - 自動給每個slide新增 data-screen-label
 *
 * 用法：
 *   <deck-stage>
...
(function() {
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // parser 此刻可能還沒處理完子 <section>，querySelectorAll 會返回空。
