...
export const MEDIA_PROVIDERS = [
  ...
  { id: 'chatgpt-web', label: 'ChatGPT Web', hint: 'Local browser automation · OpenCLI / Playwright', integrated: true, credentialsRequired: false, settingsVisible: false },
...
export const IMAGE_MODELS = [
  ...
  { id: 'chatgpt-web-image-opencli', label: 'ChatGPT Web · OpenCLI', hint: 'Local Chrome session · no OpenAI API key', provider: 'chatgpt-web', caps: ['t2i', 'browser-automation'] },
