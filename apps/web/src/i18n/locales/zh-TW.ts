...
export const zhTW: Dict = {
  ...
  "settings.modeDaemonOffline": "背景守護程式未執行",
  "settings.modeDaemonOfflineMeta": "守護程式未執行",
  ...
  "settings.mediaProvidersHint":
    "圖片、影片、音訊生成的 API key。存於本機並同步到本地守護程式。",
  ...
  "newproj.promptTemplateBodyLabel": "Prompt（可繼續最佳化）",
  ...
  "examples.typeLabel": "型別",
  "examples.surfaceLabel": "型別",
  ...
  "examples.emptyNoSkills": "沒有可用的技能，守護程式是否在執行？",
  ...
  "designFiles.sectionScripts": "指令碼",
