 ...
 *
 * 口播原順序（嚴格對齊）：
 *   1. "他的配色策略分成了：優先用品牌色；不夠就用 oklch 派生衍生色；絕對不要憑空編新色。"
 *   2. "為什麼是 oklch 呢？"
 *   3. "傳統的 HSL色彩空間有個大問題 — 感知不均勻。"
 *      "同樣的亮度值，黃色看著比藍色亮一大截。"
 *   4. "oklch 是感知均勻的色彩空間。保持亮度和色度不變，只轉色相角，出來的顏色自然就和諧。"
 *   5. "這個細節看著小，但網頁端高階感一下就上來了。"
 *
 * 節奏（5 步 / step 0..4）：
 *  0  原文 prompt（L41-43）三段被逐句"點亮" —— 引出策略原文
 *  1  三層策略卡：① 品牌色 ② oklch 派生 ③ 禁止憑空造色
 *  2  pivot 大字 "為什麼是 oklch ？" + 副："HSL 有個大問題 —— 感知不均勻"
 *  3  HSL vs OKLCH 雙色相條對比 + 感知亮度曲線 + 黃色 spotlight
 *  4  收尾："網頁端 高階感 ↑"
 */

const HUES = [0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330];

/** HSL 感知亮度（粗略 sRGB BT.709 相對亮度） */
      ...
      <SceneFade active={sceneSrc} exitMs={420} enterDelayMs={120}>
        <div className="ok__src-scene">
          ...
          <Reveal kind="fade" duration={780} delay={2200} className="ok__src-foot">
            三段 —— 一套<em>分層</em>的配色策略
          </Reveal>
        </div>
      </SceneFade>

      {/* ════════ Scene RULES（step 1）—— 三層策略 ════════ */}
          ...
          <div className="ok__rules">
            ...
            <Reveal kind="rise" duration={780} delay={220} className="ok__rule ok__rule--good">
              ...
              <div className="ok__rule-body">
                <div className="ok__rule-title">優先品牌色</div>
                <div className="ok__rule-desc">已有 design system → 直接複用，別"再創造"</div>
            ...
            <Reveal kind="rise" duration={780} delay={420} className="ok__rule ok__rule--ok">
              ...
              <div className="ok__rule-body">
                <div className="ok__rule-title">不夠用？<em>oklch 派生</em></div>
                <div className="ok__rule-desc">L / C 不變，h 旋轉 —— 自動得到和諧衍生色</div>
                <div className="ok__rule-swatches">
            ...
            <Reveal kind="rise" duration={780} delay={620} className="ok__rule ok__rule--bad">
              ...
              <div className="ok__rule-body">
                <div className="ok__rule-title">禁止憑空造色</div>
                <div className="ok__rule-desc">"我覺得這個紫色挺好看" —— 這就是 AI 味的源頭</div>
                <div className="ok__rule-swatches">
      ...
      <SceneFade active={scenePivot} exitMs={420} enterDelayMs={420}>
        <div className="ok__pivot">
          <Reveal kind="rise" duration={1100} delay={120} className="ok__pivot-q" as="h1">
            為什麼是 <em className="ok__pivot-em">oklch</em> ？
          </Reveal>
      ...
      <SceneFade active={sceneCompare} exitMs={420} enterDelayMs={420}>
        <div className="ok__cmp-scene">
          <Reveal kind="fade" duration={620} delay={80} className="ok__cmp-cap">
            同一組亮度 / 飽和度 · 12 個色相 —— 看人眼對哪種更<em>舒服</em>
          </Reveal>
